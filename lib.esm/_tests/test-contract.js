...
describe("Test Contract", function () {
    ...
    it("tests contract default overrides", async function () {
        ...
        assert.equal(tx1.gasLimit, BigInt(9999999), "contract1 default overrides gasLimit");
        assert.equal(tx1.value, BigInt(1234567890), "contract1 default overrides value");
        assert.equal(tx2.gasLimit, BigInt(2222222), "contract2 default overrides gasLimit");
